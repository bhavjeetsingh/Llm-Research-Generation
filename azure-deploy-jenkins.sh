...
LOCATION="eastasia"
STORAGE_ACCOUNT="reportjenkinsstore$(openssl rand -hex 3)"
FILE_SHARE="jenkins-data"
ACR_NAME="reportjenkinsacr$(openssl rand -hex 2)"
...
# After: az storage account create ...
# Add this:
echo "⏳ Waiting for storage account propagation..."
sleep 30

# Then continue with: STORAGE_KEY=$(az storage account keys list ...
